    ...
    return Container(
      ...
      child: Padding(
        ...
        child: DropdownButton(
            ...
            items: genderitems.map((valueItem) {  // to map each item in the genderitems list into a DropdownMenuItem widget
          ...
          style:const  TextStyle(fontSize: 14, color: Constants.kGrey),
